--------------------------------------------------------
--  DDL for Table EBA_PROJECT_TASK_TODOS
--------------------------------------------------------

  CREATE TABLE "WKSP_OACLABWS"."EBA_PROJECT_TASK_TODOS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"ASSIGNEE" VARCHAR2(255 BYTE) COLLATE "USING_NLS_COMP", 
	"IS_COMPLETE_YN" VARCHAR2(1 BYTE) COLLATE "USING_NLS_COMP", 
