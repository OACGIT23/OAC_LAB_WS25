CREATE OR REPLACE EDITIONABLE PACKAGE BODY "AI_SERVICES_PKG" as
...
--Procedure to process the uploaded file and get json output
...
--Procedure to parse and store json output to APEX collection.
