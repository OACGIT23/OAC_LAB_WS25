CREATE OR REPLACE FORCE EDITIONABLE VIEW "EBA_COUNTRIES_V" ("COUNTRY_ID", "NAME", "NATIONALITY", "COUNTRY_CODE", "CAPITAL", "POPULATION", "AREA", "REGION", "SUB_REGION", "INTERMEDIATE_REGION", "ORGNAIZATION_REGION") AS 
  select c.country_id,
c.name,
c.nationality,
c.country_code,
