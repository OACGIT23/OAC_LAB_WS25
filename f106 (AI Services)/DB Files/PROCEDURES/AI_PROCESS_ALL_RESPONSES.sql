--------------------------------------------------------
--  DDL for Procedure AI_PROCESS_ALL_RESPONSES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "WKSP_OACLABWS"."AI_PROCESS_ALL_RESPONSES" (p_feature_type IN VARCHAR2, p_response IN CLOB)
as
begin
